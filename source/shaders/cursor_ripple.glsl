...
void mainImage(out vec4 fragColor, in vec2 fragCoord){
    ...
    // Center of cursor: add half the size (adjusted for our Y-down coordinate system)
    vec2 centerCC = currentCursor.xy + vec2(currentCursor.z * 0.5, -currentCursor.w * 0.5);
